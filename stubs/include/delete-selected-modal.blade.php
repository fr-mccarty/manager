...
<form wire:submit.prevent="deleteSelected">
    <x-confirmation-modal wire:model.defer="showingDeleteModal">
        <x-slot name="title">Delete {{$entity->namePlural}}</x-slot>

        <x-slot name="content">
            <div class="py-8 text-cool-gray-700">Are you sure you want to delete these {{$entity->modelNamePlural}}? This action is irreversible.</div>
        </x-slot>
